...
csv_logger = CSVLogger('resnet18_aug.csv')
batch_size = 32
nb_classes = 100
nb_epoch = 120
...
if not data_augmentation:
    ...
    # model.load_weights('my_model_weights_aug_net.h5')

    # saver = model.save_weights('my_model_weights_e120_res34_128_128__aug.h5')
    ...
    X_testr, testDict = dataLoad.testLoad(img_rows, img_cols,gray=0)
    import cv2
    ...
    # 写入数据
    csvFile = open("res9.csv", "w",newline ='')
    ...
    for index,value in enumerate(classes):
        ...
        cv2.imwrite('c:/tempProjects/keras-resnet/vali8/'+str(np.argmax(value)+1)+'_'+testDict[index]+'.jpg', X_testre[index])
